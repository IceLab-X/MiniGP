...
# v124: another way to add mean function: directly altering y
#
...
class cigp(nn.Module):
    def __init__(self, X, Y, normal_y_mode=0, Y_alt=None):
        ...
        # simple mean function using a neural network
        self.meanFunc = nn.Sequential(nn.Linear(self.X.size(1), 8),
                nn.Sigmoid(),
                nn.Linear(8, 16),
                nn.Sigmoid(),
